...
call s:hi("StatusLineNC",  s:foreground, s:window, "")
call s:hi("StatusLineTerm", s:dark ? s:orange : s:black, s:window, "bold")
call s:hi("StatusLineTermNC",  s:foreground, s:window, "")
call s:hi("ToggleTerm1Normal", s:foreground, s:background, "")
call s:hi("ToggleTerm1StatusLine", s:dark ? s:orange : s:black, s:window, "bold")
call s:hi("ToggleTerm1StatusLineNC",  s:foreground, s:window, "")
